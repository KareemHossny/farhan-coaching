...
export type Database = {
  public: {
    Tables: {
      ...
      plan_items: {
        Row: { id: string; plan_id: string; day_of_week: number; order_index: number; library_item_id: string | null; meal_label: string | null; alternative_group: string | null; override_sets: number | null; override_reps: string | null; override_calories: number | null; override_grams: number | null; name: string | null; details: Json };
        Insert: { id?: string; plan_id: string; day_of_week: number; order_index?: number; library_item_id?: string | null; meal_label?: string | null; alternative_group?: string | null; override_sets?: number | null; override_reps?: string | null; override_calories?: number | null; override_grams?: number | null; name?: string | null; details?: Json };
        Update: { id?: string; plan_id?: string; day_of_week?: number; order_index?: number; library_item_id?: string | null; meal_label?: string | null; alternative_group?: string | null; override_sets?: number | null; override_reps?: string | null; override_calories?: number | null; override_grams?: number | null; name?: string | null; details?: Json };
        Relationships: [];
      };
      progress_logs: {
